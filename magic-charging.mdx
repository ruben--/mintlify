...
<Info>
**The pitch:** Your EV charges when it's cheapest—or earns money from grid services.\
**Benefit:** Save on charging OR earn 200-600 SEK/week during high-value periods.\
**Who it's for:** EV owners with bidirectional charging who want maximum financial return.
</Info>

# Let Your EV Earn While It Charges

**Magic Charging turns every plug-in into the best financial outcome.**

<img
  src="/images/magic-charging-hero.png"
  alt="Magic charging dashboard showing optimisation between charging savings and grid service earnings"
  noZoom={true}
  height="300"
  className="rounded-xl"
/>

Magic Charging checks every charging window and the grid-services market before it starts drawing power. If the grid will pay more than you’d save by waiting for a cheaper tariff, it takes the higher payout instead.

Traditional smart charging only chases low prices. We go further by letting your battery earn money for stabilising the grid while still meeting your departure time.
...
<CardGroup cols={1}>
  <Card title="Pick the smartest financial move" icon="scale">
    Magic Charging compares cheap tariffs with grid-service payouts and selects the option that leaves you better off.\
    **Result:** the system maximises your total benefit, not just savings.
  </Card>
  <Card title="Let your EV get paid" icon="coins">
    When reserve prices spike, your battery provides stabilisation while it charges, unlocking guaranteed capacity and activation fees.\
    **Result:** earn **200–600 kr per week** during high-value periods.
  </Card>
  <Card title="Always leave with the range you need" icon="gauge">
    We track your schedule, battery health, and departure times so the car never trades away your mobility.\
    **Result:** full automation with your EV ready when you need it.
  </Card>
</CardGroup>
...
![A diagram showing Magic Charging analysing both charging costs and grid service revenue opportunities, then choosing the optimal strategy to maximise net benefit.](/images/magic-charging/how-it-works-diagram.png)
...
2.  **Analyse Opportunities:** Every evening, our AI evaluates tomorrow's electricity prices AND the prices in grid service markets (FCR-D, FCR-N, demand response, etc.).
3.  **Optimise Strategy:** Magic Charging calculates the most profitable strategy for you:
...
| **Optimises for net benefit** | ❌ Cost only | ✅ Cost + earnings |
| **Typical annual savings** | 15,000-20,000 kr | 25,000-45,000 kr |

**The Magic Difference:** Magic Charging doesn't just minimise your costs—it **maximises your net financial position** by treating your EV as both a vehicle and a power plant on wheels.
...
### Front-of-the-meter optimisation: how Magic Charging earns money

Magic Charging leverages your EV battery to participate in the same grid service markets used by utility-scale batteries—turning your vehicle into a profit centre.
...
#### Smart Charging (cost optimisation only)
...
#### Magic Charging (cost + earnings optimisation)
...
![Magic Charging dashboard showing daily optimisation decisions between charging and grid services.](/images/magic-charging/dashboard-decisions.png)
...
<CardGroup cols={2}>
  <Card title="Smart Decision Log" icon="brain">
    See exactly why Magic Charging chose each strategy—whether it optimised for low-cost charging or high-value grid services.
  </Card>
  <Card title="Earnings Tracker" icon="line-chart">
    Track cumulative earnings from FCR-D, demand response, and V2G arbitrage, showing how your EV generates income.
  </Card>
  <Card title="Net Benefit Comparison" icon="scale">
    Compare your actual net position (costs - earnings) against what Smart Charging would have delivered.
  </Card>
  <Card title="Grid Service History" icon="radio">
...
<CardGroup cols={2}>
  ...
  <Card title="Grid Service Earnings" icon="signal">
...
<CardGroup cols={2}>
  ...
  <Card title="Charging Costs" icon="battery-charging">
    46,600 kr (8 vehicles, 12,000 kWh)
  </Card>
  <Card title="vs. Unoptimised" icon="rocket">
...
<div class="grid grid-cols-2 sm:grid-cols-3 gap-6 items-centre">
...
European grid operators are rapidly opening paid programmes for bidirectional EVs, and incentives are highest during the current transition. Deploying Magic Charging now locks in premium revenue rates before markets saturate.

**Result:** monetise your EV while policy and pricing are still stacked in your favour.
...
For EV owners with V2G-capable vehicles who want to maximise net benefit through both savings and earnings.
...
For commercial fleets with V2G-capable vehicles looking to monetise idle capacity.
...
<AccordionGroup>
  <Accordion title="How is Magic Charging different from Smart Charging?">
    Smart Charging minimises charging costs by finding the cheapest hours. Magic Charging goes further by also evaluating grid service opportunities and choosing whether saving OR earning delivers the best net financial outcome.
  </Accordion>
  <Accordion title="Will providing grid services degrade my battery faster?">
    No. Magic Charging optimises for battery health alongside revenue. V2G cycles are shallow and infrequent, well within manufacturer specifications. Studies show minimal impact on battery degradation.
  </Accordion>
  ...
  <Accordion title="Can I combine Magic Charging with home battery systems?">
    Yes! Magic Charging can coordinate with Savings Pack and Earnings Pack to optimise your entire home energy system—EV, battery, and solar—for maximum savings and earnings.
  </Accordion>
  <Accordion title="What happens if grid service markets crash?">
    Magic Charging automatically falls back to pure cost optimisation (like Smart Charging) when grid service opportunities aren't attractive. You never lose—Magic just becomes Smart.
  </Accordion>
...
<CardGroup cols={2}>
  <Card title="Residential Magic Charging" icon="sparkles" href="/get-started-magic-charging-residential">
    Start earning with your V2G-capable EV today.
  </Card>
  <Card title="Fleet Magic Charging" icon="truck" href="/get-started-magic-charging-fleet">
