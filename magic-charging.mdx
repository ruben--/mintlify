...
**Magic Charging. The only EV charging service that optimizes between saving and earning.**
...
Magic Charging is the next-generation EV charging solution that doesn't just find the cheapest hours to charge—it intelligently decides whether to charge at low prices OR earn money by providing grid services with your battery, maximizing your financial benefit every night.

Traditional EV charging focuses solely on minimizing costs. But what if your EV battery could do more? What if the value of providing grid stabilization services exceeds the cost of charging at a slightly higher price?

That's the magic. Magic Charging continuously evaluates two questions:
1. **When is it cheapest to charge?**
2. **When can I earn MORE from grid services than I'd save by waiting?**

And then it automatically chooses the path that puts the most money back in your pocket.

---

## Who it's for

Perfect for EV owners in **Sweden** and the **Nordics** with compatible vehicles and bidirectional charging capability who want to transform their EV from a cost center into a revenue-generating asset.

---

## How Magic Charging makes it happen

### ↕️ It optimizes between saving and earning

Magic Charging doesn't just wait for cheap electricity—it analyzes grid service opportunities (like FCR-D, frequency regulation, and demand response) and calculates whether the earnings exceed potential charging savings.\
**Result:** **maximize your net benefit**, whether that's lower costs or actual income.

### 💰 It turns your EV into a grid asset

When grid service prices are attractive, Magic Charging allows your EV battery to provide stabilization services, earning guaranteed payments plus activation fees—often worth more than charging cost savings.\
**Result:** **earn 200-600 kr per week** from grid services during high-value periods.

### 🧠 It makes intelligent trade-offs

Magic Charging understands your driving needs, battery state-of-charge, and upcoming schedule. It never sacrifices your mobility for earnings—your car is always ready when you need it.\
**Result:** **full automation** with zero compromise on convenience.

---

## How It Works: Intelligence Beyond Optimization

Magic Charging is more than scheduling; it's financial arbitrage powered by AI.
...
1. **Connect & Qualify:** Magic Charging integrates with your bidirectional EV charger and registers your vehicle as a qualified grid service provider.
2. **Analyze Opportunities:** Every evening, Magic Charging evaluates tomorrow's electricity prices AND grid service market prices (FCR-D, FCR-N, demand response, etc.).
3. **Optimize Strategy:** Magic Charging calculates the optimal strategy:
   ...
   - **Decision:** Choose Scenario B and earn money.
4. **Execute & Earn:** Magic Charging automatically charges when needed and provides grid services when profitable, ensuring your car is ready by your deadline.
...
**The Magic Difference:** Magic Charging doesn't just minimize costs—it **maximizes your net financial position** by treating your EV as both a vehicle and a grid asset.
...
### Revenue Stream 2: Demand Response & Peak Shaving
...
## Pricing: Aligned Incentives

### Residential Magic Charging
...
## Installation: Professional V2G Setup
