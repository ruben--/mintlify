...
## Behind-the-Meter Optimization: Real Examples

Here's exactly how Savings Pack optimizes your energy usage throughout a typical day.

### Example 1: Battery + Solar Optimization (Residential)
...
**Daily Result:**
- **Without optimization:** 68 kWh consumed × avg 1.15 kr/kWh = **78.20 kr**
...
### Example 2: HVAC + Heat Pump Optimization (Commercial)
...
<Steps>
  ...
  <Step title="15:00 - Prices moderate">
    **Price: 0.95 kr/kWh** (moderate)\
    HVAC resumes normal operation. Temperature returns to 22°C. Air quality optimized for afternoon productivity.
  </Step>
...
**Daily Result:**
- **Without optimization:** 480 kWh consumed × avg 1.12 kr/kWh = **537.60 kr**
...
**Daily Result:**
- **Without optimization:** 40 kWh × avg evening price 1.85 kr/kWh = **74 kr** to charge car
