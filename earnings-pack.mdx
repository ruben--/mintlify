...
## Front-of-the-Meter Optimization: Real Examples
...
<Steps>
  <Step title="Day-ahead market analysis (10:00 previous day)">
    Earnings Pack analyzes tomorrow's hourly price forecast:\
...
<Steps>
  ...
  <Step title="09:23 - Frequency disturbance event">
    **Grid frequency drops to 49.85 Hz** (normal is 50 Hz)\
    ...
    Battery discharges for 8 minutes until frequency stabilizes.\
...
<Steps>
  ...
  <Step title="02:30 - Rebalancing">
    Battery at 45% state-of-charge after net upward regulation. Below optimal 50% center point.\
...
**Key Insight:** FCR-N provides the highest guaranteed capacity payments but requires maintaining 50% state-of-charge and symmetric capacity. Earnings Pack continuously rebalances to minimize energy costs while maximizing availability.
...
### Example 5: Multi-Market Optimization (Arbitrage + FCR-D Stack)

**Scenario:** A 20 kWh battery using Earnings Pack's intelligent market stacking to maximize revenue across arbitrage and FCR-D simultaneously.

**What Earnings Pack Does:**

<Steps>
  <Step title="Daily strategy optimization (10:00 previous day)">
    Earnings Pack analyzes:\
...
**Key Insight:** Earnings Pack's Multi-Market Optimization intelligently splits battery capacity across multiple revenue streams, earning from both guaranteed grid service payments AND arbitrage spreads simultaneously—dramatically outperforming single-service strategies.

---

## Multi-Market Optimization (MMO): Fever's Competitive Advantage

Fever's proprietary **Multi-Market Optimization (MMO)** engine is what sets Earnings Pack apart from single-service competitors. Instead of committing your entire battery to one market for the entire day, MMO continuously evaluates all available opportunities and dynamically allocates your capacity to maximize returns.

### How MMO Works

<Steps>
  <Step title="Real-time market analysis">
    Every hour, MMO analyzes current and forecasted prices across:\
  ...
  <Step title="Continuous re-optimization">
...
<CardGroup cols={2}>
  <Card title="Markets Change Constantly" icon="chart-line-up">
  ...
  <Card title="Revenue Stacking" icon="layer-group">
  ...
  <Card title="Battery Health Optimization" icon="heart-pulse">
