...
<Accordion icon="palette" title="Update your site name and colours">
    For a first change, let's update the name and colours of your docs site.
    ...
    <Tip>Try changing the primary colour to see an immediate difference!</Tip>
  </Accordion>
</AccordionGroup>
