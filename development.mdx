...
<div className="grid grid-cols-1 md:grid-cols-2 gap-4">
  <img src="/images/espen/app-dashboard.png" alt="Espen app dashboard showing real-time earnings and energy flow." />
  <img src="/images/espen/app-report.png" alt="Espen app monthly report showing total savings and earnings." />
</div>
...
<div className="grid grid-cols-1 lg:grid-cols-2 gap-6 items-center">
  <div>
    ...
    <img src="/images/testimonials/mikael-l.jpg" alt="Friendly headshot of Mikael L." className="mt-4 rounded-lg" />
  </div>
  <div>
