...
![A diagram showing Espen at the centre, connecting the Grid, Solar, Battery, and Home, managing energy flow based on price signals.](/images/espen/how-it-works-diagram.png)
...
2. **Predict & Plan:** Our AI analyses price forecasts, weather data, and your unique energy usage patterns to create an optimal 24-hour plan.
...
<div className="grid grid-cols-1 lg:grid-cols-2 gap-6 items-centre">
<div>
<success>
...
By optimising your energy use, Espen does more than save you money. It helps you contribute to a more stable and sustainable energy grid. You'll use more power when renewable sources like wind and solar are abundant on the grid, reducing your home's carbon footprint without any effort.
...
<AccordionGroup>
  ...
  <Accordion title="Is my data secure?">
    Absolutely. We use end-to-end encryption for all communication. Your personal energy data is anonymized and used only for the purpose of optimising your savings. We never share your personal data with third parties.
  </Accordion>
